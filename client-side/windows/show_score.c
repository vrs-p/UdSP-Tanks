...
void score_create(SHOWSCORE* shwScore, int playerScore, LINKED_LIST* otherTanks) {
    ...
    vec = {(SCREEN_WIDTH - sfText_getLocalBounds(shwScore->textEndGame).width) / 2, SCREEN_HEIGHT / 2 -
    ...
    strcat(str, str2);
    strcat(str, playerScore);
    sfText_setString(shwScore->textYourScore, str);
    vec = {(SCREEN_WIDTH - sfText_getLocalBounds(shwScore->textYourScore).width) / 2, SCREEN_HEIGHT / 2};
    ...
    vec = {(SCREEN_WIDTH - sfText_getLocalBounds(shwScore->textOthersScore).width) / 2, SCREEN_HEIGHT / 2 +
...
void score_render(SHOWSCORE* shwScore) {
    ...
    sfRenderWindow_drawText(shwScore->textGame);
    sfRenderWindow_drawText(shwScore->textEndGame);
    sfRenderWindow_drawText(shwScore->textYourScore);
    sfRenderWindow_drawText(shwScore->textOthersScore);
